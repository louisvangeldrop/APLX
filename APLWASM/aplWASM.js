...
System.register("appWASM", [], function (exports_1, context_1) {
    "use strict";
    var logs, APLXTest, showPerformanceWeb, showPerformance, greeter;
    var __moduleName = context_1 && context_1.id;
    return {
        setters: [],
        execute: function () {// https://github.com/Microsoft/TypeScript/wiki
            logs = [];
            // var APL = require('./APLX.js')
            // import './APLX.mjs'
            // const { performance } = require('node:perf_hooks');
            APLXTest = class APLXTest {
                start() {
            ...
            showPerformanceWeb = function (spanCPU, performanceNow, text, expression) {
            ...
            showPerformance = (performanceNow, text, fun) => {
            ...
            exports_1("greeter", greeter = new APLXTest());
            // greeter.start()
        }
    };
});
//# sourceMappingURL=aplWASM.js.map